...
var simplechess = (function () {
    ...
    function getInitialBoard() {
        ...
        board.putCell(3, 0, { color: Color.White, piece: Piece.Queen });
        board.putCell(4, 0, { color: Color.White, piece: Piece.King });
        board.putCell(3, 7, { color: Color.Black, piece: Piece.Queen });
        board.putCell(4, 7, { color: Color.Black, piece: Piece.King });

        return board;
    }

    function putSymmetricPiece(board, x, y, piece) {
        board.putCell(x, y, { color: Color.White, piece: piece });
        board.putCell(8-x-1, y, { color: Color.White, piece: piece });        
        board.putCell(x, 8-y-1, { color: Color.Black, piece: piece });
        board.putCell(8-x-1, 8-y-1, { color: Color.Black, piece: piece });        
    }
